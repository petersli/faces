...
model.load_state_dict(torch.load('/nfs/bigdisk/peterli/AE_triplet_results/checkpoints/Epoch_999_Recon_0.0000_cosine_0.0000.pth'))
...
def test(epoch):
   ...
   # train_amount = train_amount + len(dataset)
	...
	for batch_idx, data_point in enumerate(dataloader, 0):
		...
		recon_dp9, z_dp9, z_per_dp9, z_exp_dp9 = model(dp9_img)
		recon_dp1, z_dp1, z_per_dp1, z_exp_dp1 = model(dp1_img)
